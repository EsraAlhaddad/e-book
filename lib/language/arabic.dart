...
class _ArabicState extends State<Arabic> {
  ...
  void initState() {
    super.initState();
    _isMounted = true;
    languageManager = LanguageManager('ar');
    getCurrentUser();
    getAllPdf();
  }
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(width: 4,color: AppColors.appbuttombar()),
                  color: const Color.fromARGB(255, 235, 208, 188),
                ),
                child: Row(
  ...
  children: [
    Container(
      decoration: BoxDecoration(
        border: Border.all(
          color:AppColors.appbuttombar(), // Border rengi
